...
class Boss:
    ...
    def __init__(self):
        ...
        self.idle_image = load_image('./resource\\character\\Boss\\Boss_idle.png')
        self.attack_ready_image = load_image(
            './resource\\character\\Boss\\Boss_attack_ready.png')
        self.retreat_image = load_image(
            './resource\\character\\Boss\\Boss_retreat.png')
        self.defense_image = load_image('./resource\\character\\Boss\\Boss_defense.png')
        self.attack_image = load_image('./resource\\character\\Boss\\Boss_attack.png')
        self.die_image = load_image('./resource\\character\\Boss\\Boss_die.png')
