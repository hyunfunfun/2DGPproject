...
class Attack_ready:
    ...
    @staticmethod
    def draw(enemy):
        enemy.attack_ready_image.clip_composite_draw(int(enemy.frame) * 120, 0, 110, 130,0,'h', enemy.x, enemy.y, enemy.size+30, enemy.size+30)
...
class Attack:
    ...
    @staticmethod
    def draw(enemy):
        enemy.attack_image.clip_composite_draw(int(enemy.frame) * 120, 0, 120, 120,0,'h', enemy.x, enemy.y, enemy.size+20, enemy.size+10)
...
class Defense:
    ...
    @staticmethod
    def draw(enemy):
        enemy.defense_image.clip_composite_draw(0, 0, 60, 120,0,'h', enemy.x, enemy.y, enemy.size, enemy.size)
...
class Die:
    ...
    @staticmethod
    def draw(enemy):
        enemy.die_image.clip_composite_draw(int(enemy.frame) * 55, 0, 55, 120,0,'h', enemy.x, enemy.y, enemy.size, enemy.size)
...
class Enemy2:
    ...
    def __init__(self):
        ...
        self.idle_image = load_image('./resource\\character\\enemy2\\enemy2_idle.png')
        self.attack_ready_image = load_image(
            './resource\\character\\enemy2\\enemy2_attack_ready.png')
        self.retreat_image = load_image(
            './resource\\character\\enemy2\\enemy2_retreat.png')
        self.defense_image = load_image('./resource\\character\\enemy2\\enemy2_defense.png')
        self.attack_image = load_image('./resource\\character\\enemy2\\enemy2_attack.png')
        self.die_image = load_image('./resource\\character\\enemy2\\enemy2_die.png')
