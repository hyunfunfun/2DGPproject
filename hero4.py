...
class Hero4:
    def __init__(self):
        ...
        self.attack_ready_image = load_image(
            './resource\\character\\Hero4\\Hero4_attack_ready.png')
        self.retreat_image = load_image(
            './resource\\character\\Hero4\\Hero4_retreat.png')
        self.attack_image=load_image('./resource\\character\\Hero4\\Hero4_attack.png')
        self.die_image=load_image('./resource\\character\\Hero4\\Hero4_die.png')
        self.defense_image=load_image('./resource\\character\\Hero4\\Hero4_defense.png')
